...
<div class="flex flex-col items-center justify-center min-h-screen bg-gray-50">
  <form class="bg-white p-8 rounded shadow w-full max-w-sm" on:submit|preventDefault={handleLogin}>
    ...
    <button class="btn w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700" type="submit">Login</button>
